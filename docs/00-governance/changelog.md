...
## [22.3A] — Analytics Runtime Wiring

### Added

* Analytics Engine runtime execution wiring
* Automatic analytics recomputation after audit events
* Analytics Registry auto-population after persistence operations
...
Analytics is now executable instead of scaffold-only.
...
automatically trigger analytics recomputation.
...
* No workflow/recovery/transaction changes
