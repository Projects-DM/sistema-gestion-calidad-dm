                      ...
                      <tr key={m.id} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end gap-2">
                            <button
                              type="button"
                              className="p-2 text-gray-400 bg-gray-50 rounded-lg transition-colors cursor-not-allowed"
                              disabled
                              title="Editar módulo pendiente de implementación (sin rutas nuevas en esta fase)"
                            >
